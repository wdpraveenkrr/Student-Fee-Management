...
const id = userData? userData.studentid : ""
    ...
    const result = records.filter((dt) => {
        return  dt.studentId === id ? dt.items : ""
    })

    // console.log(result);

     const totalpaid = result.filter((item) => {
    ...
    return (
        ...
        <div className='flex items-start'>
            ...
            <div className='m-3'>
                ...
                <div className='flex items-center justify-between m-3 p-1 rounded mt-20 w-4xl'>
