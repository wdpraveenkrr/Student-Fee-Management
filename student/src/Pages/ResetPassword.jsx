...
const ResetPassword = () => {
  ...
  const onSubmitEmail = async(e)=>{
    e.preventDefault()
    try {
      const {data} = await api.post(backendUrl + '/api/student/send-reset-otp',{email})
    ...
    const onSubmitNewPassword = async(e)=>{
      ...
      try {
        ...
        const {data} = await api.post(backendUrl + '/api/student/reset-password', {email, otp, newPassword})
