...
const EditStudent = () => {
    ...
    const onSubmitHandler = async (e) => {
      ...
      formData.append("studentpic", studentprofile)
      formData.append("studentdob", studentdob)
      formData.append("studentgender", studentgender)
      formData.append("studenteducation", studenteducation)
      formData.append("studentbloodgroup", studentbloodgroup)
      formData.append("studentmobileno", studentmobileno)
      formData.append("studentaddress", studentaddress) 
            ...
            const { data } = await Axios.put(backendUrl + `/api/student/update/${id}`, formData, {
                headers: {
    ...
    return (
         ...
         <div className='flex flex-col mt-15 ' >
                <div className='flex justify-between p-3 items-center'>
                    ...
                    <button className='bg-black px-8 py-1.5 mr-5 text-white rounded-full' onClick={() => navigate('/studentlist/')} >Back</button>
                </div>
